...
export default function Navbar() {
    ...
    return(
        <nav style={{ backdropFilter: 'blur(6.7px)' }} className={` ${scrolled ? 'bg-opacity-60' : ''} bg-bgDark px-4 md:px-8 lg:px-20 xl:px-32 py-4 fixed  z-50 top-0 left-0 right-0  text-gray`}>
            {/* larger screens */}
