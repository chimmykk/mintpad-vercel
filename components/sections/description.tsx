...
export default function Description(){
    return(
        <main className=" w-full text-white px-4 md:h-[900px] lg:px-64 pt-32 relative" style={{ backgroundImage: `url('/images/nftbackground.webp')`, backgroundSize: 'cover' }}>
            <div className="absolute top-0 left-0 w-full h-full z-10">
                <div className="h-full" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}></div>
            </div>
            <h1 className="w-full text-center text-[20px] md:text-[26px] relative z-20">
